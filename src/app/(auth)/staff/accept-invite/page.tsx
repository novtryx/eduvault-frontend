  ...
  if (!token) {
    return (
      <div className="rounded-xl border border-border bg-white p-8 text-center shadow-card">
        ...
        <h1 className="text-[18px] font-semibold text-navy-900">Invalid invite link</h1>
  ...
  if (accepted) {
    return (
      <div className="rounded-xl border border-border bg-white p-8 text-center shadow-card">
        ...
        <h1 className="text-[18px] font-semibold text-navy-900">You're all set</h1>
        <p className="mt-1.5 text-[13.5px] text-navy-400">
  ...
  return (
    <div>
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <h1 className="text-[20px] font-semibold text-navy-900">Accept your invitation</h1>
        <p className="mt-1 text-[13.5px] text-navy-400">Set a password to activate your staff account</p>
      </div>
